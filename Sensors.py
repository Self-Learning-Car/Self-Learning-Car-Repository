...
class Sensors():
    def __init__(self, car, parked_car_list):
        ...
        sensor = [[car.center_x + math.cos(math.radians(360 - (-car.angle))) * lenght_front,
                  car.center_y + math.sin(math.radians(360 - (-car.angle))) * lenght_front],
                  [car.center_x + math.cos(math.radians(340 - (-car.angle))) * lenght_front,
                  car.center_y + math.sin(math.radians(340 - (-car.angle))) * lenght_front],
                  ...
                  [car.center_x + math.cos(math.radians(200 - (-car.angle))) * lenght_front,
                  car.center_y + math.sin(math.radians(200 - (-car.angle))) * lenght_front],
                  [car.center_x + math.cos(math.radians(180 - (-car.angle))) * lenght_front,
                  car.center_y + math.sin(math.radians(180 - (-car.angle))) * lenght_front],
                  [car.center_x + math.cos(math.radians(160 - (-car.angle))) * lenght_front,
                  car.center_y + math.sin(math.radians(160 - (-car.angle))) * lenght_front],
                  ...
                  [car.center_x + math.cos(math.radians(20 - (-car.angle))) * lenght_front,
                  car.center_y + math.sin(math.radians(20 - (-car.angle))) * lenght_front]]
        ...
        self.distance(sensor, car, parked_car_list)
